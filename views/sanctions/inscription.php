...
<div class="container mt-5">
    ...
    <form action="" method="POST" class="mt-4">
        <div class="mb-3">
            ...
            <input type="text" class="form-control" name="prenom" id="prenom" placeholder="Votre prénom" values="<?= $prenom ?>">
        </div>
        <div class="mb-3">
            <label for="nom" class="form-label">Votre Nom</label>
            <input type="text" class="form-control" name="nom" id="nom" placeholder="Votre nom" values="<?= $nom ?>">
        </div>
        <div class="mb-3">
            <label for="email" class="form-label">Votre adresse Email</label>
            <input type="email" class="form-control" name="email" id="email" placeholder="email@domaine.com" values="<?= $email ?>">
        </div>
        <div class="mb-3">
